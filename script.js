...
const moreButton5 = document.getElementById('more-button5');
const moreButton6 = document.getElementById('more-button6');
const moreButton7 = document.getElementById('more-button7');
const moreButton8 = document.getElementById('more-button8');
const moreButton9 = document.getElementById('more-button9');
const moreButton10 = document.getElementById('more-button10');
const moreButton11 = document.getElementById('more-button11');

moreButton1.addEventListener('click', () => {
    const hobby1info = document.getElementById('hobby1info');
    if (moreButton1.textContent === 'Read More') {    
...
moreButton2.addEventListener('click', () => {
    ...
    if (moreButton2.textContent === 'Read More') {    
...
moreButton3.addEventListener('click', () => {
    ...
    if (moreButton3.textContent === 'Read More') {    
...
moreButton4.addEventListener('click', () => {
    ...
    if (moreButton4.textContent === 'Read More') {    
        hobby4info.className = 'visible-info';
        moreButton4.textContent = 'Less';
...
moreButton5.addEventListener('click', () => {
    ...
    if (moreButton5.textContent === 'Read More') {    
        hobby5info.className = 'visible-info';
        moreButton5.textContent = 'Less';
...
moreButton6.addEventListener('click', () => {
    ...
    if (moreButton6.textContent === 'Read More') {    
        hobby6info.className = 'visible-info';
        moreButton6.textContent = 'Less';
...
moreButton7.addEventListener('click', () => {
    ...
    if (moreButton7.textContent === 'Read More') {    
        hobby7info.className = 'visible-info';
        moreButton7.textContent = 'Less';
...
moreButton8.addEventListener('click', () => {
    ...
    if (moreButton8.textContent === 'Read More') {    
        hobby8info.className = 'visible-info';
        moreButton8.textContent = 'Less';
...
moreButton10.addEventListener('click', () => {
    ...
    if (moreButton10.textContent === 'Read More') {    
        hobby10info.className = 'visible-info';
        moreButton10.textContent = 'Less';
...
moreButton11.addEventListener('click', () => {
    ...
    if (moreButton11.textContent === 'Read More') {    
        hobby11info.className = 'visible-info';
        moreButton11.textContent = 'Less';
